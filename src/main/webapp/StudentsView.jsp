...
<body class="flex flex-col min-h-screen items-center justify-center" data-theme="corporate">
<div class="flex flex-col content-center h-[600px] overflow-y-auto overflow-x-hidden">
                    ...
                    <tr class="border-b dark:border-neutral-500">
                        ...
                        <td>
                            <a class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded"
                               href="${pageContext.request.contextPath}/update-student-servlet?id=${student.getId()}">Update</a>
                            <a class="bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white py-2 px-4 border border-red-500 hover:border-transparent rounded"
                               href="${pageContext.request.contextPath}/delete-student-servlet?id=<c:out value='${student.getId()}'/>">Delete</a>
                        </td>
                    </tr>
                    </tbody>
                    </c:forEach>
